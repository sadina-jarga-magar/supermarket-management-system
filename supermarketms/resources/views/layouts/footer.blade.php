	...
	<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
		<div class="flex-w p-b-90">
			<div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
				...
				<div>
					<p class="s-text7 w-size27">
						Any questions? Let us know in store at 3rd floor, putali line street, Dharan or call us on (+977) 9803933811
					</p>
					<p class="s-text7 w-size27">
			...
			<div class="t-center s-text8 p-t-20">
				Copyright © 2019 All rights reserved, little mart.com | Designed  <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">:SadinaJMagar</a>
			</div>
		</div>
	</footer>
